            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="order" id="order" value="{{ old('order', $module->lessons->count() + 1) }}" min="1" required
                               class="w-full p-3 rounded-xl bg-gray-900 text-white border border-gray-600 outline-none">
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="10" required
                                  class="w-full p-3 rounded-xl bg-gray-900 text-white border border-gray-600 outline-none">{{ old('content') }}</textarea>
                    </div>
                </div>
