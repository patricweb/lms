        ...
        <form method="POST" action="{{ route('categoriesStore') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required
                       class="w-full px-4 py-2 rounded-lg bg-[#25292c] border border-gray-600 text-white placeholder-gray-400 focus:outline-none">
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          class="w-full px-4 py-2 rounded-lg bg-[#25292c] border border-gray-600 text-white placeholder-gray-400 focus:outline-none">{{ old('description') }}</textarea>
            ...
            <div class="flex gap-3 mt-4">
                ...
                <a href="{{ route('categoriesIndex') }}"
                   class="bg-gray-600 hover:bg-gray-700 text-white font-medium px-6 py-2 rounded-lg transition transform hover:scale-105 shadow hover:shadow-gray-700/25">
                    Назад
                </a>
            </div>
        </form>
