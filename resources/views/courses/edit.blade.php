        ...
        <form action="{{ route('updateCourse', $course) }}" method="POST" enctype="multipart/form-data" class="space-y-10">
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    @if($course->thumbnail)
                        <img src="{{ asset('storage/' . $course->thumbnail) }}" class="h-48 w-full object-cover rounded-lg border border-gray-700 shadow-md">
                    @endif
            ...
            <div class="pt-4 mb-6">
                <button type="submit" class="px-10 py-3 bg-emerald-600 hover:bg-emerald-700 text-text-gray-900 text-lg rounded-xl font-semibold transition">
                    Сохранить изменения
                </button>
            </div>
        </form>
