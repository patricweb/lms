        ...
        <div class=" p-8 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="5"
                    class="w-full bg-[#0d1013] text-white px-4 py-3 rounded-lg border border-gray-700 outline-none transition">{{ old('description', $course->description) }}</textarea>
            </div>
            <div class="space-y-2">
        ...
        <div class="p-8 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <select name="category_id"
                        class="w-full bg-[#0d1013] text-white px-4 py-3 rounded-lg border border-gray-700 transition">
