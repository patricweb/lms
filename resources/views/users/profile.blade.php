    ...
    <div class="container mx-auto px-4">
        ...
        <div class="bg-[#18181b] rounded-2xl p-8 mb-8 border border-gray-700">
            <div class="flex items-center justify-between">
                ...
                <!-- Edit Profile Button -->
                <a href="{{ route('profile') }}" class="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 flex items-center gap-2">
